...
public class Permisos extends AppCompatActivity {
            ...
            handler.postDelayed(new Runnable() {
                public void run() {
                    if (ContextCompat.checkSelfPermission(Permisos.this, android.Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED) {
                        ...
                        solicitarPermiso(Manifest.permission.CALL_PHONE, "Sin el permiso" + " de telefono no podemos realizar llamadas.", 0);
                    }
                }
            }, 2000L);
        }
    ...
    void permisoalmacenamiento() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED) {
            ...
            solicitarPermiso(Manifest.permission.WRITE_EXTERNAL_STORAGE, "Sin el permiso" + " de Almacenamiento no podemos guardar su informacion.", 2);
        }
    }
    ...
    void permisocuenta() {
        if (ContextCompat.checkSelfPermission(this, Manifest.permission.GET_ACCOUNTS) == PackageManager.PERMISSION_GRANTED) {
            ...
            solicitarPermiso(Manifest.permission.GET_ACCOUNTS, "Sin el permiso" + " de contactos no podemos vincularnos con google o facebook.", 3);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        if (requestCode == 3) {
            if (grantResults.length == 1 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                solicitarPermiso(Manifest.permission.GET_ACCOUNTS, "Sin el permiso" + " de cuentas no podemos vincularnos con google o facebook.", 3);
            }
        }
    }
